...
import one from './images/tw.png'
import two from './images/o.png'
      ...
      >
        ...
        <motion.div className="left" variants={item}>
          ...
          <motion.p className="st-desc" variants={item}
            ...
            Wearing a weathered red leather jacket and a confident smirk. His rebellious spirit embodies freedom and defiance.
          </motion.p>
