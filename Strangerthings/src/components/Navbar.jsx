...
export default function Navbar() {
  ...
  <span className="text-yellow-200 text-lg font-bold tracking-wider group-hover:text-cyan-400 transition-colors duration-300">STRANGER THINGS</span>
</div>
