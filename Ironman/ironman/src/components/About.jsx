...
export default function About() {
  ...
  Behind every exceptional digital product is a combination of engineering precision and creative vision. As a Full-Stack Developer, I design scalable systems, craft immersive interfaces, and transform ambitious ideas into high-performance web experiences inspired by innovation, technology, and continuous evolution.
</p>
          </div>
  ...
  <p className="text-xl md:text-2xl text-gray-200 font-mono">
    ...
    <br />
    Innovation happens when engineering meets imagination.”
  </p>
</blockquote>
          </div>
