...
import Kaleen1 from '../assets/k.jpg';
import Kaleen2 from '../assets/k.jpg';
      ...
      <div className="max-w-[90rem] w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
        ...
        <div ref={textContainerRef} className="flex flex-col justify-center space-y-10">
          ...
          <div className="overflow-hidden">
            <h2 className="stagger-reveal text-5xl md:text-6xl font-bold tracking-tighter text-white leading-tight">
 <br />
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-yellow-400 to-white font-mono tracking-wider uppercase pr-4">
  ...
  Undisputed king of a multi-million-dollar carpet export empire. But behind the looms lies a much darker truth: he controls every gun, every drug, and every threat that crosses his borders. He doesn't need to raise his voice to command a room; his presence alone demands total submission.
</p>
          </div>
  ...
  <p className="text-xl md:text-2xl text-gray-200 font-mono">
