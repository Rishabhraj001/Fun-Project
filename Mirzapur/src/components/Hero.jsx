...
import videosrc from "../assets/0628.mp4";
import manVideo from "../assets/back.mp4";
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-black flex items-center justify-center">
      ...
      <div ref={textRef} className="absolute inset-0 z-10 pointer-events-none flex flex-col justify-center mx-auto w-full max-w-[90rem] px-8 lg:px-16 mt-20">
        <div
          className="w-full flex flex-col md:flex-row justify-between md:items-end transition-all duration-700 ease-out transform gap-10 mt-30 ml-15"
        ...
        >
          ...
          <div className="flex-1 max-w-lg lg:max-w-xl text-left">
            ...
            <h1 className="text-2xl md:text-3xl xl:text-[3.5rem] font-bold tracking-tighter leading-[1.35]">
             आपका<br />
