    ...
    <section id="contact" className="contact" ref={sectionRef}>
      <div className="container contact__inner">
        <div className="contact__text contact__animate">
          <p className="eyebrow">Got Talent? Got Latent.</p>
          <h2>Think you can survive the panel?</h2>
          <p className="contact__sub">
            Tell us what you do — sing, juggle, roast, whatever it is — and our team will reach out
            about auditioning for the next season.
          </p>
        </div>
