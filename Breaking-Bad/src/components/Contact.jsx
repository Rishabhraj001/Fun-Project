      ...
      <div className="max-w-2xl w-full relative z-10 flex flex-col items-center text-center">
        ...
        <div className="mb-12 animate-element">
          ...
          <h2 className="text-5xl md:text-7xl font-bold tracking-tighter text-white font-sans leading-none mb-6 drop-shadow-xl">
            Let's <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-white font-serif italic pr-2">Cook</span>
          </h2>
          <p className="text-gray-400 font-light text-lg tracking-wide leading-relaxed max-w-xl mx-auto">
            Whether you want to Get Good scores in life or just want to experience the knowledge, or just want to talk shop—my inbox is always open. Let’s collaborate and architect the cooked future of tomorrow.
          </p>
        </div>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="w-full flex flex-col space-y-6">
          ...
          <div className="animate-element pt-4 flex justify-center">
            <button 
              type="submit" 
              className="relative group overflow-hidden rounded-full w-full md:w-auto px-12 py-4 border border-green-500/30 bg-black text-white text-sm uppercase tracking-[0.2em] font-medium transition-all duration-500 hover:scale-[1.02] hover:border-green-500 shadow-[0_0_0_rgba(239,68,68,0)] hover:shadow-[0_0_30px_rgba(239,68,68,0.3)]"
            >
              
              <span className="absolute inset-0 bg-gradient-to-r from-green-600/0 via-green-600/20 to-green-600/0 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]" />
              
              <span className="relative z-10 flex items-center justify-center space-x-3">
                <span>Transmit Message</span>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="transform group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300 text-green-500">
